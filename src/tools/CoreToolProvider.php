...
class CoreToolProvider extends Component implements McpToolProviderInterface
{
    ...
    public function getTools(): array
    {
        ...
        return [
            ...
            $this->tool('cms_content_property_list', 'Дополнительные поля типа публикации.', 'cms.content.read', [$content, 'contentPropertyList'], $this->objectSchema(['content_id' => ['type' => 'integer']], ['content_id'])),
